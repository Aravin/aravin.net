  ...
  return (
    <Layout categories={categories} seo={Seo}>
      ...
      <div>
        ...
        <div className="bg-white rounded px-5 py-5 mb-5 w-full">
            ...
            <div className="p-5 rounded">
              <div className="card text-center shadow-2xl">
                ...
                <div className="card-body">
                  ...
                  <p>
                    Upcoming open source project with everyday tools and
                    services
                  </p>
                  <div className="justify-center card-actions">
                    <div>
            ...
            <div className="p-5 rounded">
              <div className="card text-center shadow-2xl">
                ...
                <div className="card-body">
                  ...
                  <p>
                    SIP, SWP, STP and Lumpsum returns Calculator Android App
                  </p>
                  <div className="justify-center card-actions">
                    <div>
            ...
            <div className="p-5 rounded">
              <div className="card text-center shadow-2xl">
                ...
                <div className="card-body">
                  ...
                  <p>
                    Android application to manage your product or service
                    warranty
                  </p>
                  <div className="justify-center card-actions">
                    <div>
            ...
            <div className="p-5 rounded">
              <div className="card text-center shadow-2xl">
                ...
                <div className="card-body">
                  ...
                  <p>
                    Android application to calculate the Loan EMI and Compare Loans
                  </p>
                  <div className="justify-center card-actions">
                    <div>
                      <div className="badge badge-primary m-2">Flutter</div>
        ...
        <div className="bg-white rounded px-5 py-5 mb-5 w-full">
          <div className="text-center">
            <h2 className="mb-5 text-3xl font-bold">Recent Writings</h2>
          </div>
          <div>
