          ...
          <div className="sm:px-3 lg:px-2 max-w-7xl mx-auto px-2">
            <div className="relative flex items-center justify-center h-14">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-primary hover:text-white hover:bg-primary focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <div className="flex-1 flex sm:items-stretch sm:justify-start items-center justify-center md:justify-between">
                <div className="flex-shrink-0 flex items-center">
                  <span className="font-bold bg-primary text-white p-2 text-xl2 shadow rounded">
                    <Link to="/">ARAVIN.NET</Link>
                  </span>
                </div>
                  ...
                  <div className="flex space-x-4">
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={`${
                          location.pathname.includes(item.urlMatch || '')
